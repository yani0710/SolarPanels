...
const QA_DATA: QA[] = [
  ...
  },
  {
    ...
    aBG: 'За домакинство с 5–10 kWp цената е между 4 000 и 9 000 € с монтаж. Средното изплащане е 6–9 години. Цените са паднали значително — сега е добро време за инвестиция.',
  ...
  },
  {
    ...
    aBG: 'В България при ~0.11 €/kWh и добра ориентация, 5 kWp система се изплаща за 6–8 години. С покачване на цените на тока — по-бързо. Средният живот на панелите е 25–30 години.',
